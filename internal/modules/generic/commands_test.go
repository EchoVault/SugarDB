	...
	t.Run("Test_HandlerRENAMENX", func(t *testing.T) {
		...
		tests := []struct {
		...
		}{
			{
				...
				newKey:           "newKey1",
				presetValue:      "value1",
				command:          []resp.Value{resp.StringValue("RENAMENX"), resp.StringValue("oldKey1"), resp.StringValue("newKey1")},
				expectedResponse: "OK",
				expectedError:    nil,
			},
			{
				...
				newKey:           "newKey2",
				presetValue:      nil,
				command:          []resp.Value{resp.StringValue("RENAMENX"), resp.StringValue("oldKey2"), resp.StringValue("newKey2")},
				expectedResponse: "",
				expectedError:    errors.New("no such key"),
			},
			{
				...
				newKey:           "newKey3",
				presetValue:      "value3",
				command:          []resp.Value{resp.StringValue("RENAMENX"), resp.StringValue("oldKey3"), resp.StringValue("newKey3")},
				expectedResponse: "OK",
				expectedError:    nil,
			},
			{
